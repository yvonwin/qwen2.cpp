...
static inline void print_message(const qwen::ChatMessage &message) { std::cout << message.content << "\n"; }
...
static auto chat(Args &args) -> void {
    ...
    qwen::GenerationConfig gen_config(args.max_length, args.max_context_length, args.temp > 0, args.top_k, args.top_p,
                                      args.temp, args.repeat_penalty, args.num_threads);
