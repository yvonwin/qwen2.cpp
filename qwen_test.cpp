...
class QwenTest : public ::testing::Test {
  protected:
    ...
    auto device_graph_compute(int n_threads) -> void { cpu_graph_compute(n_threads); }
...
TEST(Pipeline, Qwen2) {
    ...
    // tokenizer
    {
        std::vector<TokenizerTestCase> cases{
            {"你好", {108386}},
            {"你好！有什么我可以帮助你的吗？", {108386, 6313, 104139, 109944, 100364, 103929, 101037, 11319}},
        };
    ...
    // prompter
    {
        EXPECT_EQ(QwenTokenizer::build_prompt(
                      {{ChatMessage::ROLE_SYSTEM, "You are a helpful assistant."}, {ChatMessage::ROLE_USER, "你好"}}),
                  "<|im_start|>system\nYou are a helpful "
                  "assistant.<|im_end|>\n<|im_start|>user\n你好<|im_end|>\n<|im_start|>assistant\n");
    }
    ...
    // chat
    {
        GenerationConfig gen_config;
        gen_config.do_sample = false;
        std::vector<ChatMessage> messages{{ChatMessage::ROLE_SYSTEM, "You are a helpful assistant."},
...
TEST(Pipeline, Llama3) {
    ...
    // tokenizer
    {
        std::vector<TokenizerTestCase> cases{
            ...
            {"This is a response.", {2028, 374, 264, 2077, 13}},
        };
        check_tokenizer(pipeline.tokenizer.get(), cases);
    }
    ...
    // chat
    {
        ...
        EXPECT_EQ(output.content,
                  "Hello! How can I help you today? Is there something you would like to talk about or ask me a "
                  "question? I'm here to provide information and answer any questions you may have to the best of my "
                  "ability. Feel free to ask me anything, and I'll do my best to assist you.");
    }
}
